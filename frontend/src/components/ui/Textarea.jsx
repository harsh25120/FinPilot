  ...
  return (
    <div className={containerClassName}>
      ...
      <textarea
        ...
        ref={ref}
        rows={rows}
        className={`w-full resize-none rounded-lg border bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/40 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-600 ${
          error
